...
class Reputation extends Model {
    ...
    // Define las asociaciones estáticas de manera adecuada
    public static associations: {
      user: Association<Reputation, User>; // Define la asociación con User de manera correcta
    };
  }
  
  // Inicializa el modelo Reputation
  Reputation.init({
    id: {
...
class Payment extends Model {
    ...
    // Define las asociaciones estáticas de manera adecuada
    public static associations: {
      order: Association<Payment, Order>; // Define la asociación con Order de manera correcta
    };
  }
  
  // Inicializa el modelo Payment
  Payment.init({
    id: {
      type: DataTypes.INTEGER,
      primaryKey: true,
  ...
  class Dispute extends Model {
    ...
    // Define las asociaciones estáticas de manera adecuada
    public static associations: {
      order: Association<Dispute, Order>; // Define la asociación con Order de manera correcta
      user: Association<Dispute, User>; // Define la asociación con User de manera correcta
    };
  }
  
  // Inicializa el modelo Dispute
  Dispute.init({
    id: {
      type: DataTypes.INTEGER,
      primaryKey: true,
