    ...
    try {
        ...
        const product = await Product.findOne({
          ...
          include: [
            ...
            {
              model: Review,
              attributes: ["rating", "comment"], // Agregar el nombre del usuario
              include: [{ model: User, attributes: ["name"] }], // Incluir el modelo de usuario para obtener el nombre
          ...
          attributes: [
            ...
            "categoryId",
            "image",
          ], // Especifica los atributos que deseas incluir de Product
        });
