...
let Address = (() => {
    let _classDecorators = [(0, sequelize_typescript_1.Table)({ modelName: 'Address' })];
    ...
    var Address = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.address = (__runInitializers(this, _userId_extraInitializers), __runInitializers(this, _address_initializers, void 0));
            this.user = (__runInitializers(this, _address_extraInitializers), __runInitializers(this, _user_initializers, void 0));
